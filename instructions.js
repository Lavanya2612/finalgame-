    ...
    display(){
      ...
      //  var title = createElement('h1')
       ...
       // title.position(displayWidth/2-150 ,50); 
        ...
        this.title5.html("You have 5 lives and there are 2 levels...");
        this.title5.position(displayWidth/2 -250, 450);

        
       this.title6.html("In the first level, you need to collect all the coins.");
        this.title6.position(displayWidth/2 -250, 500);

        this.title7.html("In the second level, you need to reach the treasure!");
        this.title7.position(displayWidth/2 -250, 550);

        this.button.position(displayWidth/2 +50, 650)
